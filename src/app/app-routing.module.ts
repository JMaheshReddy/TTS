...
const routes: Routes = [
  ...
  { path: 'applicationsetting/organization', component: ViewprofileComponent },
  { path: 'addprofile', component: AddprofileComponent },
  { path: 'applicationsetting/department', component: ViewdepartmentComponent },
  { path: 'adddepratment', component: AdddepartmentComponent },
  { path: 'viewlocation', component: ViewlocationComponent },
  { path: 'addlocation', component: AddlocationComponent },
  { path: 'applicationsetting/role', component: ViewroleComponent },
  { path: 'addrole', component: AddroleComponent },
  { path: 'applicationsetting/employee', component: ViewemployeeComponent },
